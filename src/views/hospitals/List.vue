...
import { URL_API, getHdrs, getErr, getRsp, getEncodeId, getPercentFormat } from '@/general'
...
onMounted(() => {
  headers.value = [
    ...
    { title: 'Comisión', key: 'fee' },
    { title: 'RFC', key: 'fiscal_code' },
    { title: 'Estado', key: 'address_town.state.name' },
    { title: 'Municipio', key: 'address_town.name' },
    { title: 'ID', key: 'uiid' },
