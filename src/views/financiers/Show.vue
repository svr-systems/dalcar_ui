          ...
          <v-card>
            <v-card-title>
              <v-row dense>
                <v-col cols="11">
                  <CardTitle
                    :text="`DATOS GENERALES | ${item.uiid || ''}`"
                    sub
                  />
                </v-col>
            ...
            <v-card-text>
              <v-row dense>
                ...
                <v-col cols="12" md="6">
                  <VisVal label="Sitio web" :value="item.website" />
                </v-col>
        ...
        <v-col cols="12">
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                <v-col cols="12" md="6">
                  <VisVal label="Nombre" :value="item.contact_name" />
                </v-col>

                <v-col cols="12" md="6">
                  <VisVal label="E-mail" :value="item.contact_email" />
                </v-col>

                <v-col cols="12" md="6">
                  <VisVal label="Teléfono" :value="item.contact_phone" />
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
